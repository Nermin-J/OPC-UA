...
namespace Siemens.UAClientHelper
{
    public class UAClientHelperAPI
    {
        ...
        public ReferenceDescriptionCollection ReadStructProperties(string nodeId)
        {
            //Create a collection for the browse results
            ReferenceDescriptionCollection referenceDescriptionCollection;
            //Create a continuationPoint
            ...
            try
            {
                //Browse the RootFolder for variables
                mSession.Browse(null, null, nodeId, 0u, BrowseDirection.Forward, ReferenceTypeIds.HierarchicalReferences, true, (uint)NodeClass.Variable, out continuationPoint, out referenceDescriptionCollection);
                return referenceDescriptionCollection;
            }
            catch (Exception e)
            {
